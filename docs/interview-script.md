...
Na vaga, eles citam manutencao de Windows Forms, migracao para .NET/.NET Core e Angular, CRUD em SQL Server, boas praticas e code review. Este projeto cobre esses pontos em uma aplicacao pequena, mas com arquitetura parecida com um sistema corporativo real.
